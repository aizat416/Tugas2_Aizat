...
<html lang="en" class="ms-5 me-5">
  ...
  <body>
    ...
    <a href="<?php echo URL; ?>/golongan/create" class="btn btn-success mb-2">Tambah Golongan</a>
            ...
            <?php
                foreach($data as $row){ ?>
                    <tr>
                        ...
                        <td class="text-center" style="width:50px;"><a href="<?= URL; ?>/golongan/edit/<?= $row['gol_id']; ?>" class="badge text-bg-primary text-decoration-none">Edit</a></td>
